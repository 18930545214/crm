		...
		<div class="content-wrapper">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 data">
						<div class="input-group date">
							...
							<input type="text" class="form-control pull-right"
								id="datepicker-a6" value="${product.departureTime}"
								readonly="readonly">
						</div>
					</div>
			...
			<div class="panel panel-default">
				...
				<table id="dataList"
					...
					<tbody>
						<c:forEach var="traveller" items="${traveller}">

							<tr>
								<td>${(traveller.travellerType>0?'儿童':'成人')}</td>
			...
			<!--联系人信息/--> <!--费用信息--> <c:if test="${order.orderStatus==1}">
				<div class="panel panel-default">
					...
					<div class="row data-type">
						...
						<div class="col-md-4 data text">${(order.payType>0?'微信':'支付宝')}</div>

						<div class="col-md-2 title">金额</div>
						<div class="col-md-4 data text">￥${order.peopleCount*product.productPrice}</div>
