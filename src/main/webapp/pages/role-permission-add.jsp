...
<link rel="stylesheet"
	...
	<script>
		$(function () {
			//发送ajax请求
			$.get("${pageContext.request.contextPath}/permission/queryAll",function (data) {
				//此代码要使用jquery进行拼接
		...
		function add() {
			...
			var permissionId = isCheckbox();
			if (permissionId === "id"){
				layer.alert('你还没有选中哦', {icon: 7});
			}else {
				$.post("${pageContext.request.contextPath}/role/addPermission",
						{"roleId":roleId,"permissionId":permissionId}
						, function (data) {
							if (data.info === "success") {
								layer.msg('添加成功', {icon: 6});
								window.location="role-list.jsp"
							} else {
		...
		<div class="content-wrapper">
			...
			<form>
				...
				<div class="box-tools text-center">
					<button type="button" class="btn bg-maroon" onclick="add()">保存</button>
