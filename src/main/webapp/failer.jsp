		...
		<ul class="sidebar-menu">
			...
			<li class="treeview"><a href="#"> <i class="fa fa-cogs"></i>
				...
				<ul class="treeview-menu">
					...
					<li class="system-setting"><a href="${pageContext.request.contextPath}/role/findAll.do">
							<i class="fa fa-circle-o"></i> 角色管理
					</a></li>
					<li class="system-setting"><a href="${pageContext.request.contextPath}/permission/findAll.do">
